...
const HomePage = () => {
    ...
    const handleCareerPress = () => {
        navigation.navigate('Career'); // Replace 'ContactUs' with the screen name for the contact form/details
    };
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.contactUsContainer}>
                ...
                <Text style={styles.sectionHeading} onPress={handleCareerPress}>Careers
                 {/* <FontAwesome5 name="arrow-right" size={20} color="#333" style={styles.arrowIcon} onPress={handleContactUsPress} /> */}
                 </Text>
